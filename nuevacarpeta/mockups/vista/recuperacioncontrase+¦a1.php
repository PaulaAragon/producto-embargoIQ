            ...
            <div class="login-form">
               <form action="../controlador/controlador.php" method="post">
                  ...
                  <div class="form-group">
                     ...
                     <h6>Ingresa tu numero de identificacion para  <br>
							recuperar la contraseña.</h6>
                     <input type="text" class="form-control" placeholder="ingresa tu numero de documento" name="u" required>
                  </div>
                  <div class="form-group">
                  
                  </div>
		<div>		   
			<input class="btn btn-primary" type="button" value="Volver" style="width: 130px; height: 40px; position:absolute; top: 135px; left: 40px;  	background-color:#E00003" name="" onClick="location.href='index.php'">	    
				   </div>
				   
				   <div>
       <input class="btn btn-warning" type="submit" value="Siguiente" style="width: 180px; height: 40px; position:absolute; top: 135px; left: 200px;  	background-color:#00CBFF" name="op8">
       </div>
