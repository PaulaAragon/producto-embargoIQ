...
.form__link{
 ...
 <body style="background: darkgrey;">
   ...
   <form action="capturaespecializada.php"  method="POST" class="form-register">
   
	
	   
   	<div class="contenedor-inputs">
   	 <input type="text" name="registro" placeholder="Identificacion Registro" class="input-48"required>
		<input type="submit" value="Consultar" name="opp" class="btn btn-info btn-block rounded-0 py-2" style="background: green; color:white;" required>
